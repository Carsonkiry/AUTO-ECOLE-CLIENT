            ...
            <div class="col-md-12">
                        ...
                        if(isset($_GET['err'])){
                            ...
                            switch($err){
                                ...
                                case 'success_password':
                                    echo "<div class='alert alert-success'>Le mot de passe à était modifié avec succès ! </div>";
                                break; 
                            }
                        }
                    ?>
                ...
                <div class="text-center">
                        ...
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#change_password">
                          Changer mon mot de passe actuelle
                        </button>
                        <a href="CODE/index.html" class="btn btn-info btn-lg">Code</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe actuelle</h5>
